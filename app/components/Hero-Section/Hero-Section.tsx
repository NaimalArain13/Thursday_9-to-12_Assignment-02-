...
export default function HeroSection() {
  return (
    <div className="mx-auto overflow-hidden bg-neutral-100 flex flex-col items-center pt-10 md:pt-20 min-h-screen space-y-4 md:space-y-6 text-center px-4">
      ...
      <div className="md:flex-row flex-col space-y-5  md:space-x-5 pt-6">
        <Button className="bg-black text-lg text-white px-4 md:px-8 py-6 rounded-full shadow-md hover:bg-gray-800 transition duration-200">
          GET FREE ACCOUNT
        </Button>
        <Button className="bg-yellow-500 text-lg text-black px-4 md:px-8 py-6 rounded-full shadow-md hover:bg-yellow-600 transition duration-200">
          VIEW PRODUCT DEMO
        </Button>
      </div>
      <p className="text-gray-500 text-sm pt-2">No credit card required</p>
    </div>
  );
}
